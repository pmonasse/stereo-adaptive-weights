...
{
	int factor=4, sense=0; // Camera motion direction: '0'=to-right, '1'=to-left
	CmdLine cmd;
	...
	if(! save_disparity_factor(OUTFILE1, disparity, dMin,dMax, factor)) {
	...
	if(! save_disparity_factor(OUTFILE2, disparity, dMin,dMax, factor)) {
